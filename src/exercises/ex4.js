...
// Fonction pour formater les données météo
...
// Fonction pour afficher ou masquer les données météo
const toggleWeatherData = async () => {
  const cityName = 'Bordeaux'; // Exemple de nom de ville (peut être remplacé par un autre nom dynamiquement)
...
document.addEventListener('DOMContentLoaded', () => {
  // Écouteur d'événement pour afficher/masquer les données météo lorsque le bouton est cliqué
